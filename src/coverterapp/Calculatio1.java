...
package coverterapp;
	...
	value2=currency_converter. Dollar_TO_Inr (value1);
	System.out.printf("%.2f Dollar is equal to %.2f INR .\n", value1,value2);
	break;
	case 2:
	System.out.print("Enter the amount:");
	value1=sc.nextDouble();
	value2=currency_converter.INR_TO_Dollar(value1);
	System.out.printf("%.2f INR is equal to %.2f Dollar .\n", value1,value2);
	break;
	case 3:
	System.out.print("Enter the amount:");
	value1=sc.nextDouble();
	value2=currency_converter.Euro_To_Inr(value1);
	...
	System.out.print("Enter the amount:");
	value1=sc.nextDouble();
	value2=currency_converter.Inr_To_Euro(value1);
	System.out.printf("%.2f Inr is equal to %.2f Euro .\n", value1,value2);
	   break;
	case 5:
	System.out.print("Enter the amount:");
	value1=sc.nextDouble();
	value2=currency_converter.Yen_To_Inr(value1);
	System.out.printf("%.2f Yen is equal to %.2f INR .\n", value1,value2);
	   break;
	case 6:
	System.out.print("Enter the amount:");
	value1=sc.nextDouble();
	value2=currency_converter.Inr_To_Yen(value1);
