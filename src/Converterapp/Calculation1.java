/***
 * To write a program for conversion of currency,time,distance
...
import java.util.Scanner;
		...
		System.out.println("11.hours to minutees conversion");
		...
		System.out.printf("%.2f Kpackage converterlibrary;\n" + 
				"\n" + 
				"public class TimeConverter {\n" + 
				"\n" + 
				"}\n" + 
				"M is equal to %.2f miles .\n",value1,value2);
		break;
		case 11:
